...
{
	internal class NullableCollectionOfNullablePropertyHandler<TObject, TValue, TSource> : ValigatorJsonPropertyHandler<TObject>
	{
		private readonly Func<TObject, Data<Option<Option<TValue>[]>>> _getValue;
		private readonly Action<TObject, Data<Option<Option<TValue>[]>>> _setValue;
		...
		public NullableCollectionOfNullablePropertyHandler(PropertyInfo property)
		{
			PropertyName = property.Name;
			_getValue = property.GetGetter<TObject, Option<Option<TValue>[]>>();
			_setValue = property.GetSetter<TObject, Option<Option<TValue>[]>>();
		}
