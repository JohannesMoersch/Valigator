...
namespace Valigator.Core.StateValidators
{
	public struct NullableOptionalCollectionStateValidator<TValue> : ICollectionStateValidator<Option<TValue[]>, TValue>
	{
		...
		public DataSourceStandard<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TValue, TValue>, Option<TValue[]>, TValue[], TValueValidator> Add<TValueValidator>(TValueValidator valueValidator)
		...
		public DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> MappedFrom<TSource>(Func<TSource, TValue> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> MappedFrom<TSource>(Func<TSource, Result<TValue, ValidationError[]>> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> MappedFrom<TSource>(Func<TSource, TValue> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));

		public DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> MappedFrom<TSource>(Func<TSource, Result<TValue, ValidationError[]>> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));

		private DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> MappedFrom<TSource>(Mapping<TSource, TValue> mapping)
			=> new DataSource<NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]>(new NullableCollectionDataContainerFactory<NullableOptionalCollectionStateValidator<TValue>, TSource, TValue>(this, mapping));
