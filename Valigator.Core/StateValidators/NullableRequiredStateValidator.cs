...
namespace Valigator.Core.StateValidators
{
	public struct NullableRequiredStateValidator<TValue> : IStateValidator<Option<TValue>, TValue>
	{
		...
		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, TValue> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Result<TValue, ValidationError[]>> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, TValue> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Result<TValue, ValidationError[]>> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));
