...
namespace Valigator.Core.StateValidators
{
	public struct NullableRequiredStateValidator<TValue> : IStateValidator<Option<TValue>, TValue>
	{
		...
		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Option<TValue>> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Result<Option<TValue>, ValidationError[]>> mapper)
			=> MappedFrom(Mapping.Create(mapper));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Option<TValue>> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));

		public DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Func<TSource, Result<Option<TValue>, ValidationError[]>> mapper, Func<RequiredStateValidator<TSource>, Data<TSource>> sourceValidations)
			=> MappedFrom(Mapping.Create(mapper, sourceValidations));

		private DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> MappedFrom<TSource>(Mapping<TSource, TValue> mapping)
			=> new DataSource<NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue>(new NullableDataContainerFactory<NullableRequiredStateValidator<TValue>, TSource, TValue>(this, mapping));
