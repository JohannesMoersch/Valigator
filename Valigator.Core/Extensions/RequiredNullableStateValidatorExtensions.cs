...
namespace Valigator
{
	public static class RequiredNullableStateValidatorExtensions
	{
		...
		public static NullableDataSource<RequiredNullableStateValidator<TValue>, CustomValidator<TValue>, TValue> Assert<TValue>(this RequiredNullableStateValidator<TValue> requiredValidator, string description, Func<TValue, bool> validator)
			=> new NullableDataSource<RequiredNullableStateValidator<TValue>, CustomValidator<TValue>, TValue>(requiredValidator, new CustomValidator<TValue>(description, validator));

		public static NullableDataSource<RequiredNullableStateValidator<decimal>, PrecisionValidator, decimal> Precision(this RequiredNullableStateValidator<decimal> requiredValidator, decimal? minimumDecimalPlaces, decimal? maximumDecimalPlaces)
			=> new NullableDataSource<RequiredNullableStateValidator<decimal>, PrecisionValidator, decimal>(requiredValidator, new PrecisionValidator(minimumDecimalPlaces, maximumDecimalPlaces));

		public static NullableDataSource<RequiredNullableStateValidator<TValue>, InSetValidator<TValue>, TValue> InSet<TValue>(this RequiredNullableStateValidator<TValue> requiredValidator, params TValue[] options)
		...
		public static NullableDataSource<RequiredNullableStateValidator<string>, StringLengthValidator, string> Length(this RequiredNullableStateValidator<string> requiredValidator, int? minimumLength = null, int? maximumLength = null)
			=> new NullableDataSource<RequiredNullableStateValidator<string>, StringLengthValidator, string>(requiredValidator, new StringLengthValidator(minimumLength, maximumLength));
		...
		public static NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime> LessThan(this RequiredNullableStateValidator<DateTime> requiredValidator, DateTime value)
			=> new NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime>(requiredValidator, new RangeValidator_DateTime(value, false, null, false));

		public static NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime> LessThanOrEqualTo(this RequiredNullableStateValidator<DateTime> requiredValidator, DateTime value)
			=> new NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime>(requiredValidator, new RangeValidator_DateTime(value, true, null, false));

		public static NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime> GreaterThan(this RequiredNullableStateValidator<DateTime> requiredValidator, DateTime value)
			=> new NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime>(requiredValidator, new RangeValidator_DateTime(null, false, value, false));

		public static NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime> GreaterThanOrEqualTo(this RequiredNullableStateValidator<DateTime> requiredValidator, DateTime value)
			=> new NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime>(requiredValidator, new RangeValidator_DateTime(null, false, value, true));

		public static NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime> InRange(this RequiredNullableStateValidator<DateTime> requiredValidator, DateTime? lessThan = null, DateTime? lessThanOrEqualTo = null, DateTime? greaterThan = null, DateTime? greaterThanOrEqualTo = null)
		{
			if (lessThan.HasValue && lessThanOrEqualTo.HasValue)
				throw new ArgumentOutOfRangeException(nameof(lessThan), $"{nameof(lessThan)} and {nameof(lessThanOrEqualTo)} cannot both be specified.");
			...
			return new NullableDataSource<RequiredNullableStateValidator<DateTime>, RangeValidator_DateTime, DateTime>(requiredValidator, new RangeValidator_DateTime(lessThan ?? lessThanOrEqualTo, lessThanOrEqualTo.HasValue, greaterThan ?? greaterThanOrEqualTo, greaterThanOrEqualTo.HasValue));
		}
	}
}
