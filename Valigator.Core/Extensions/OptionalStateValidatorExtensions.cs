...
namespace Valigator
{
	public static class OptionalStateValidatorExtensions
	{
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue, EqualsValidator<TValue>> EqualTo<TSource, TValue>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> source, TValue value)
			=> source.Add(new EqualsValidator<TValue>(value));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<string>, TSource, string>, Option<string>, string, EqualsValidator<string>> NotEmpty<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<string>, TSource, string>, Option<string>, string> source)
			=> source.Not(s => s.Add(new EqualsValidator<string>(String.Empty)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<Guid>, TSource, Guid>, Option<Guid>, Guid, EqualsValidator<Guid>> NotEmpty<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<Guid>, TSource, Guid>, Option<Guid>, Guid> source)
			=> source.Not(s => s.Add(new EqualsValidator<Guid>(Guid.Empty)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, EqualsValidator<byte>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source)
			=> source.Not(s => s.Add(new EqualsValidator<byte>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, EqualsValidator<sbyte>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source)
			=> source.Not(s => s.Add(new EqualsValidator<sbyte>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, EqualsValidator<short>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source)
			=> source.Not(s => s.Add(new EqualsValidator<short>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, EqualsValidator<ushort>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source)
			=> source.Not(s => s.Add(new EqualsValidator<ushort>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, EqualsValidator<int>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source)
			=> source.Not(s => s.Add(new EqualsValidator<int>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, EqualsValidator<uint>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source)
			=> source.Not(s => s.Add(new EqualsValidator<uint>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, EqualsValidator<long>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source)
			=> source.Not(s => s.Add(new EqualsValidator<long>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, EqualsValidator<ulong>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source)
			=> source.Not(s => s.Add(new EqualsValidator<ulong>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float, EqualsValidator<float>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float> source)
			=> source.Not(s => s.Add(new EqualsValidator<float>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double, EqualsValidator<double>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double> source)
			=> source.Not(s => s.Add(new EqualsValidator<double>(0)));
		...
		public static DataSourceInverted<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, EqualsValidator<decimal>> NotZero<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source)
			=> source.Not(s => s.Add(new EqualsValidator<decimal>(0)));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue, InSetValidator<TValue>> InSet<TSource, TValue>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> source, params TValue[] options)
			=> source.Add(new InSetValidator<TValue>(options));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue, InSetValidator<TValue>> InSet<TSource, TValue>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<TValue>, TSource, TValue>, Option<TValue>, TValue> source, ISet<TValue> options)
			=> source.Add(new InSetValidator<TValue>(options));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, MultipleOfValidator_Byte> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte divisor)
			=> source.Add(new MultipleOfValidator_Byte(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, MultipleOfValidator_SByte> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte divisor)
			=> source.Add(new MultipleOfValidator_SByte(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, MultipleOfValidator_Int16> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source, short divisor)
			=> source.Add(new MultipleOfValidator_Int16(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, MultipleOfValidator_Int32> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int divisor)
			=> source.Add(new MultipleOfValidator_Int32(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, MultipleOfValidator_UInt32> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint divisor)
			=> source.Add(new MultipleOfValidator_UInt32(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, MultipleOfValidator_Int64> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long divisor)
			=> source.Add(new MultipleOfValidator_Int64(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, MultipleOfValidator_UInt64> MultipleOf<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source, ulong divisor)
			=> source.Add(new MultipleOfValidator_UInt64(divisor));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, RangeValidator_Byte> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte value)
			=> source.Add(new RangeValidator_Byte(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, RangeValidator_Byte> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte value)
			=> source.Add(new RangeValidator_Byte(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, RangeValidator_Byte> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte value)
			=> source.Add(new RangeValidator_Byte(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, RangeValidator_Byte> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte value)
			=> source.Add(new RangeValidator_Byte(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte, RangeValidator_Byte> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<byte>, TSource, byte>, Option<byte>, byte> source, byte? greaterThan = null, byte? greaterThanOrEqualTo = null, byte? lessThan = null, byte? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_Byte(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, RangeValidator_SByte> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte value)
			=> source.Add(new RangeValidator_SByte(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, RangeValidator_SByte> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte value)
			=> source.Add(new RangeValidator_SByte(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, RangeValidator_SByte> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte value)
			=> source.Add(new RangeValidator_SByte(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, RangeValidator_SByte> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte value)
			=> source.Add(new RangeValidator_SByte(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte, RangeValidator_SByte> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<sbyte>, TSource, sbyte>, Option<sbyte>, sbyte> source, sbyte? greaterThan = null, sbyte? greaterThanOrEqualTo = null, sbyte? lessThan = null, sbyte? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_SByte(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, RangeValidator_Int16> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source, short value)
			=> source.Add(new RangeValidator_Int16(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, RangeValidator_Int16> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source, short value)
			=> source.Add(new RangeValidator_Int16(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, RangeValidator_Int16> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source, short value)
			=> source.Add(new RangeValidator_Int16(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short, RangeValidator_Int16> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<short>, TSource, short>, Option<short>, short> source, short value)
			=> source.Add(new RangeValidator_Int16(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, RangeValidator_UInt16> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source, ushort value)
			=> source.Add(new RangeValidator_UInt16(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, RangeValidator_UInt16> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source, ushort value)
			=> source.Add(new RangeValidator_UInt16(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, RangeValidator_UInt16> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source, ushort value)
			=> source.Add(new RangeValidator_UInt16(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, RangeValidator_UInt16> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source, ushort value)
			=> source.Add(new RangeValidator_UInt16(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort, RangeValidator_UInt16> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ushort>, TSource, ushort>, Option<ushort>, ushort> source, ushort? greaterThan = null, ushort? greaterThanOrEqualTo = null, ushort? lessThan = null, ushort? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_UInt16(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, RangeValidator_Int32> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int value)
			=> source.Add(new RangeValidator_Int32(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, RangeValidator_Int32> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int value)
			=> source.Add(new RangeValidator_Int32(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, RangeValidator_Int32> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int value)
			=> source.Add(new RangeValidator_Int32(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, RangeValidator_Int32> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int value)
			=> source.Add(new RangeValidator_Int32(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int, RangeValidator_Int32> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<int>, TSource, int>, Option<int>, int> source, int? greaterThan = null, int? greaterThanOrEqualTo = null, int? lessThan = null, int? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_Int32(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, RangeValidator_UInt32> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint value)
			=> source.Add(new RangeValidator_UInt32(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, RangeValidator_UInt32> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint value)
			=> source.Add(new RangeValidator_UInt32(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, RangeValidator_UInt32> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint value)
			=> source.Add(new RangeValidator_UInt32(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, RangeValidator_UInt32> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint value)
			=> source.Add(new RangeValidator_UInt32(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint, RangeValidator_UInt32> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<uint>, TSource, uint>, Option<uint>, uint> source, uint? greaterThan = null, uint? greaterThanOrEqualTo = null, uint? lessThan = null, uint? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_UInt32(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, RangeValidator_Int64> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long value)
			=> source.Add(new RangeValidator_Int64(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, RangeValidator_Int64> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long value)
			=> source.Add(new RangeValidator_Int64(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, RangeValidator_Int64> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long value)
			=> source.Add(new RangeValidator_Int64(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, RangeValidator_Int64> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long value)
			=> source.Add(new RangeValidator_Int64(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long, RangeValidator_Int64> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<long>, TSource, long>, Option<long>, long> source, long? greaterThan = null, long? greaterThanOrEqualTo = null, long? lessThan = null, long? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_Int64(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, RangeValidator_UInt64> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source, ulong value)
			=> source.Add(new RangeValidator_UInt64(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, RangeValidator_UInt64> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source, ulong value)
			=> source.Add(new RangeValidator_UInt64(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, RangeValidator_UInt64> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source, ulong value)
			=> source.Add(new RangeValidator_UInt64(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong, RangeValidator_UInt64> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<ulong>, TSource, ulong>, Option<ulong>, ulong> source, ulong value)
			=> source.Add(new RangeValidator_UInt64(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float, RangeValidator_Single> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float> source, float value)
			=> source.Add(new RangeValidator_Single(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float, RangeValidator_Single> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float> source, float value)
			=> source.Add(new RangeValidator_Single(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float, RangeValidator_Single> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float> source, float value)
			=> source.Add(new RangeValidator_Single(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float, RangeValidator_Single> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<float>, TSource, float>, Option<float>, float> source, float value)
			=> source.Add(new RangeValidator_Single(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double, RangeValidator_Double> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double> source, double value)
			=> source.Add(new RangeValidator_Double(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double, RangeValidator_Double> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<double>, TSource, double>, Option<double>, double> source, double value)
			=> source.Add(new RangeValidator_Double(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, RangeValidator_Decimal> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source, decimal value)
			=> source.Add(new RangeValidator_Decimal(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, RangeValidator_Decimal> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source, decimal value)
			=> source.Add(new RangeValidator_Decimal(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, RangeValidator_Decimal> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source, decimal value)
			=> source.Add(new RangeValidator_Decimal(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, RangeValidator_Decimal> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source, decimal value)
			=> source.Add(new RangeValidator_Decimal(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal, RangeValidator_Decimal> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<decimal>, TSource, decimal>, Option<decimal>, decimal> source, decimal? greaterThan = null, decimal? greaterThanOrEqualTo = null, decimal? lessThan = null, decimal? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_Decimal(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime, RangeValidator_DateTime> GreaterThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime> source, DateTime value)
			=> source.Add(new RangeValidator_DateTime(value, null, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime, RangeValidator_DateTime> GreaterThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime> source, DateTime value)
			=> source.Add(new RangeValidator_DateTime(null, value, null, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime, RangeValidator_DateTime> LessThan<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime> source, DateTime value)
			=> source.Add(new RangeValidator_DateTime(null, null, value, null));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime, RangeValidator_DateTime> LessThanOrEqualTo<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime> source, DateTime value)
			=> source.Add(new RangeValidator_DateTime(null, null, null, value));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime, RangeValidator_DateTime> InRange<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<DateTime>, TSource, DateTime>, Option<DateTime>, DateTime> source, DateTime? greaterThan = null, DateTime? greaterThanOrEqualTo = null, DateTime? lessThan = null, DateTime? lessThanOrEqualTo = null)
			=> source.Add(new RangeValidator_DateTime(greaterThan, greaterThanOrEqualTo, lessThan, lessThanOrEqualTo));
		...
		public static DataSourceStandard<NullableDataContainerFactory<OptionalStateValidator<string>, TSource, string>, Option<string>, string, StringLengthValidator> Length<TSource>(this DataSource<NullableDataContainerFactory<OptionalStateValidator<string>, TSource, string>, Option<string>, string> source, int? minimumLength = null, int? maximumLength = null)
			=> source.Add(new StringLengthValidator(minimumLength, maximumLength));
