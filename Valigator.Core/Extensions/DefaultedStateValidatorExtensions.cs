...
namespace Valigator
{
	public static class DefaultedStateValidatorExtensions
	{
		...
		public static DataSourceStandard<DefaultedStateValidator<TValue>, EqualsValidator<TValue>, TValue> Equals<TValue>(this DefaultedStateValidator<TValue> source, TValue value)
			=> source.Add(new EqualsValidator<TValue>(value));

		public static DataSourceStandard<DefaultedStateValidator<string>, EqualsValidator<string>, string> NotEmpty(this DefaultedStateValidator<string> source)
			=> source.Add(new EqualsValidator<string>(String.Empty));

		public static DataSourceStandard<DefaultedStateValidator<Guid>, EqualsValidator<Guid>, Guid> NotEmpty(this DefaultedStateValidator<Guid> source)
			=> source.Add(new EqualsValidator<Guid>(Guid.Empty));

		public static DataSourceStandard<DefaultedStateValidator<byte>, EqualsValidator<byte>, byte> NotZero(this DefaultedStateValidator<byte> source)
			=> source.Add(new EqualsValidator<byte>(0));

		public static DataSourceStandard<DefaultedStateValidator<sbyte>, EqualsValidator<sbyte>, sbyte> NotZero(this DefaultedStateValidator<sbyte> source)
			=> source.Add(new EqualsValidator<sbyte>(0));

		public static DataSourceStandard<DefaultedStateValidator<short>, EqualsValidator<short>, short> NotZero(this DefaultedStateValidator<short> source)
			=> source.Add(new EqualsValidator<short>(0));

		public static DataSourceStandard<DefaultedStateValidator<ushort>, EqualsValidator<ushort>, ushort> NotZero(this DefaultedStateValidator<ushort> source)
			=> source.Add(new EqualsValidator<ushort>(0));

		public static DataSourceStandard<DefaultedStateValidator<int>, EqualsValidator<int>, int> NotZero(this DefaultedStateValidator<int> source)
			=> source.Add(new EqualsValidator<int>(0));

		public static DataSourceStandard<DefaultedStateValidator<uint>, EqualsValidator<uint>, uint> NotZero(this DefaultedStateValidator<uint> source)
			=> source.Add(new EqualsValidator<uint>(0));

		public static DataSourceStandard<DefaultedStateValidator<long>, EqualsValidator<long>, long> NotZero(this DefaultedStateValidator<long> source)
			=> source.Add(new EqualsValidator<long>(0));

		public static DataSourceStandard<DefaultedStateValidator<ulong>, EqualsValidator<ulong>, ulong> NotZero(this DefaultedStateValidator<ulong> source)
			=> source.Add(new EqualsValidator<ulong>(0));

		public static DataSourceStandard<DefaultedStateValidator<float>, EqualsValidator<float>, float> NotZero(this DefaultedStateValidator<float> source)
			=> source.Add(new EqualsValidator<float>(0));

		public static DataSourceStandard<DefaultedStateValidator<double>, EqualsValidator<double>, double> NotZero(this DefaultedStateValidator<double> source)
			=> source.Add(new EqualsValidator<double>(0));

		public static DataSourceStandard<DefaultedStateValidator<decimal>, EqualsValidator<decimal>, decimal> NotZero(this DefaultedStateValidator<decimal> source)
		...
		public static DataSourceStandard<DefaultedStateValidator<byte>, RangeValidator_Byte, byte> InRange(this DefaultedStateValidator<byte> source, byte? lessThan = null, byte? lessThanOrEqualTo = null, byte? greaterThan = null, byte? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<sbyte>, RangeValidator_SByte, sbyte> InRange(this DefaultedStateValidator<sbyte> source, sbyte? lessThan = null, sbyte? lessThanOrEqualTo = null, sbyte? greaterThan = null, sbyte? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<short>, RangeValidator_Int16, short> InRange(this DefaultedStateValidator<short> source, short? lessThan = null, short? lessThanOrEqualTo = null, short? greaterThan = null, short? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<ushort>, RangeValidator_UInt16, ushort> InRange(this DefaultedStateValidator<ushort> source, ushort? lessThan = null, ushort? lessThanOrEqualTo = null, ushort? greaterThan = null, ushort? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<int>, RangeValidator_Int32, int> InRange(this DefaultedStateValidator<int> source, int? lessThan = null, int? lessThanOrEqualTo = null, int? greaterThan = null, int? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<uint>, RangeValidator_UInt32, uint> InRange(this DefaultedStateValidator<uint> source, uint? lessThan = null, uint? lessThanOrEqualTo = null, uint? greaterThan = null, uint? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<long>, RangeValidator_Int64, long> InRange(this DefaultedStateValidator<long> source, long? lessThan = null, long? lessThanOrEqualTo = null, long? greaterThan = null, long? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<ulong>, RangeValidator_UInt64, ulong> InRange(this DefaultedStateValidator<ulong> source, ulong? lessThan = null, ulong? lessThanOrEqualTo = null, ulong? greaterThan = null, ulong? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<float>, RangeValidator_Single, float> InRange(this DefaultedStateValidator<float> source, float? lessThan = null, float? lessThanOrEqualTo = null, float? greaterThan = null, float? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<double>, RangeValidator_Double, double> InRange(this DefaultedStateValidator<double> source, double? lessThan = null, double? lessThanOrEqualTo = null, double? greaterThan = null, double? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<decimal>, RangeValidator_Decimal, decimal> InRange(this DefaultedStateValidator<decimal> source, decimal? lessThan = null, decimal? lessThanOrEqualTo = null, decimal? greaterThan = null, decimal? greaterThanOrEqualTo = null)
		...
		public static DataSourceStandard<DefaultedStateValidator<DateTime>, RangeValidator_DateTime, DateTime> InRange(this DefaultedStateValidator<DateTime> source, DateTime? lessThan = null, DateTime? lessThanOrEqualTo = null, DateTime? greaterThan = null, DateTime? greaterThanOrEqualTo = null)
			=> source.Add(new RangeValidator_DateTime(lessThan, lessThanOrEqualTo, greaterThan, greaterThanOrEqualTo));

		public static DataSourceStandard<DefaultedStateValidator<string>, StringLengthValidator, string> Length(this DefaultedStateValidator<string> source, int? minimumDecimalPlaces = null, int? maximumDecimalPlaces = null)
