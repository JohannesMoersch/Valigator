...
namespace Valigator
{
	public static class NullableDefaultedCollectionStateValidatorExtensions
	{
		...
		public static DataSourceStandard<NullableCollectionDataContainerFactory<NullableDefaultedCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[], UniqueValidator<TValue>> Unique<TSource, TValue>(this DataSource<NullableCollectionDataContainerFactory<NullableDefaultedCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> source)
			=> source.Add(new UniqueValidator<TValue>());
		...
		public static DataSourceStandard<NullableCollectionDataContainerFactory<NullableDefaultedCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[], ItemCountValidator<TValue>> ItemCount<TSource, TValue>(this DataSource<NullableCollectionDataContainerFactory<NullableDefaultedCollectionStateValidator<TValue>, TSource, TValue>, Option<TValue[]>, TValue[]> source, int? minimumItems = null, int? maximumItems = null)
			=> source.Add(new ItemCountValidator<TValue>(minimumItems, maximumItems));
