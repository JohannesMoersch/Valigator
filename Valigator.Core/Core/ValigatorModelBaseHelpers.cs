...
namespace Valigator.Core
{
	internal class CustomFieldInfo : FieldInfo
	{
		...
		public override object[] GetCustomAttributes(Type attributeType, bool inherit) => _inner.GetCustomAttributes(attributeType, inherit).Append(new ValidateContentsAttribute()).ToArray();
