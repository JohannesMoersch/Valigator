...
{
	public struct OptionalNullableCollectionDataContainerFactory<TStateValidator, TSource, TValue> : IDataContainerFactory<Optional<Option<TValue[]>>, TValue[]>
		where TStateValidator : struct, ICollectionStateValidator<Optional<Option<TValue[]>>, TValue>
	{
		...
		public OptionalNullableCollectionDataContainerFactory(TStateValidator stateValidator, Mapping<TSource, TValue> mapping)
		{
		...
		public IDataContainer<Optional<Option<TValue[]>>> Create<TValueValidatorOne, TValueValidatorTwo, TValueValidatorThree>(TValueValidatorOne valueValidatorOne, TValueValidatorTwo valueValidatorTwo, TValueValidatorThree valueValidatorThree)
			...
			=> new OptionalNullableCollectionDataContainer<TStateValidator, TValueValidatorOne, TValueValidatorTwo, TValueValidatorThree, TSource, TValue>(_mapping, _stateValidator, valueValidatorOne, valueValidatorTwo, valueValidatorThree);
	}
}
