...
namespace Valigator.Core
{
		...
		where TValueValidatorThree : IValueValidator<TValue>
	{
		...
		public DataSourceStandardStandardInverted(TStateValidator stateValidator, TValueValidatorOne valueValidatorOne, TValueValidatorTwo valueValidatorTwo, TValueValidatorThree valueValidatorThree, Func<TSource, TValue> mapper)
		{
