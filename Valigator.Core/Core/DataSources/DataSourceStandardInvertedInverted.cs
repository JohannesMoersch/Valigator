...
{
	public struct DataSourceStandardInvertedInverted<TDataContainerFactory, TDataValue, TValue, TValueValidatorOne, TValueValidatorTwo, TValueValidatorThree>
		...
		where TValueValidatorThree : struct, IValueValidator<TValue>
	{
		...
		public static implicit operator Data<TDataValue>(DataSourceStandardInvertedInverted<TDataContainerFactory, TDataValue, TValue, TValueValidatorOne, TValueValidatorTwo, TValueValidatorThree> dataSource)
			=> dataSource.Data;
	}
}
