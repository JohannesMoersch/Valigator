...
namespace Valigator.Core.DataSources
{
		...
		where TValueValidatorThree : IValueValidator<TValue>
	{
		...
		public DataSourceStandardInvertedStandard(TStateValidator stateValidator, TValueValidatorOne valueValidatorOne, TValueValidatorTwo valueValidatorTwo, TValueValidatorThree valueValidatorThree, Mapping<TSource, TValue> mapper)
		{
