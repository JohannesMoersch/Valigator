...
namespace Valigator.Core.DataSources
{
		...
		where TValueValidatorThree : IValueValidator<TValue>
	{
		...
		public DataSourceInvertedInvertedInverted(TStateValidator stateValidator, TValueValidatorOne valueValidatorOne, TValueValidatorTwo valueValidatorTwo, TValueValidatorThree valueValidatorThree, Mapping<TSource, TValue> mapper)
		{
