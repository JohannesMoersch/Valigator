...
namespace Valigator.Core
{
		...
		where TValueValidatorTwo : IValueValidator<TValue>
	{
		...
		public NullableDataSourceInvertedStandard(TStateValidator stateValidator, TValueValidatorOne valueValidatorOne, TValueValidatorTwo valueValidatorTwo, Mapping<TSource, TValue> mapper)
		{
