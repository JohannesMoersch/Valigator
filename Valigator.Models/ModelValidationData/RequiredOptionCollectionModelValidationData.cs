...
namespace Valigator.ModelValidationData
{
	public class RequiredOptionCollectionModelValidationData<TModel, TValue> : IModelPropertyData<TModel, IReadOnlyList<Option<TValue>>, IReadOnlyList<Option<TValue>>>, IRootModelValidationData<RequiredOptionCollectionModelValidationData<TModel, TValue>, TModel, IReadOnlyList<Option<TValue>>>
	{
		...
		public static ModelDefinition<TModel>.Property<IReadOnlyList<Option<TValue>>> ToProperty(RequiredOptionCollectionModelValidationData<TModel, TValue> data)
			=> new ModelDefinition<TModel>.Property<IReadOnlyList<Option<TValue>>>(data);

		public static implicit operator ModelDefinition<TModel>.Property<IReadOnlyList<Option<TValue>>>(RequiredOptionCollectionModelValidationData<TModel, TValue> data)
			=> ToProperty(data);
	}
}
