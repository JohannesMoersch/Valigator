...
{
	public class DefaultedOptionDictionaryModelValidationData<TModel, TKey, TValue> : IModelPropertyData<TModel, IReadOnlyDictionary<TKey, Option<TValue>>, IReadOnlyDictionary<TKey, Option<TValue>>>, IRootModelValidationData<DefaultedOptionDictionaryModelValidationData<TModel, TKey, TValue>, TModel, IReadOnlyDictionary<TKey, Option<TValue>>>
	{
		...
		public static ModelDefinition<TModel>.Property<IReadOnlyDictionary<TKey, Option<TValue>>> ToProperty(DefaultedOptionDictionaryModelValidationData<TModel, TKey, TValue> data)
			=> new ModelDefinition<TModel>.Property<IReadOnlyDictionary<TKey, Option<TValue>>>(data);

		public static implicit operator ModelDefinition<TModel>.Property<IReadOnlyDictionary<TKey, Option<TValue>>>(DefaultedOptionDictionaryModelValidationData<TModel, TKey, TValue> data)
			=> ToProperty(data);
	}
}
