...
{
	public class OptionalOptionDictionaryModelValidationData<TModel, TKey, TValue> : IModelPropertyData<TModel, IReadOnlyDictionary<TKey, Option<TValue>>, Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>, IRootModelValidationData<OptionalOptionDictionaryModelValidationData<TModel, TKey, TValue>, TModel, IReadOnlyDictionary<TKey, Option<TValue>>>
	{
		...
		public static ModelDefinition<TModel>.Property<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>> ToProperty(OptionalOptionDictionaryModelValidationData<TModel, TKey, TValue> data)
			=> new ModelDefinition<TModel>.Property<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>(data);

		public static implicit operator ModelDefinition<TModel>.Property<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>(OptionalOptionDictionaryModelValidationData<TModel, TKey, TValue> data)
			=> ToProperty(data);
	}
}
