...
{
	public class OptionalNullableOptionDictionaryValidationData<TKey, TValue> : ValidationDataBase<Optional<Option<IReadOnlyDictionary<TKey, Option<TValue>>>>>, IPropertyData<IReadOnlyDictionary<TKey, Option<TValue>>, Optional<Option<IReadOnlyDictionary<TKey, Option<TValue>>>>>, IRootValidationData<OptionalNullableOptionDictionaryValidationData<TKey, TValue>, IReadOnlyDictionary<TKey, Option<TValue>>>
	{
		...
		public override Result<Unit, ValidationError[]> Validate(Optional<Option<IReadOnlyDictionary<TKey, Option<TValue>>>> value)
		{
