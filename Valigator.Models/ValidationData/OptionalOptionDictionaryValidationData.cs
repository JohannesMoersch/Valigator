...
namespace Valigator.ValidationData
{
	public class OptionalOptionDictionaryValidationData<TKey, TValue> : IPropertyData<IReadOnlyDictionary<TKey, Option<TValue>>, Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>, IRootValidationData<OptionalOptionDictionaryValidationData<TKey, TValue>, IReadOnlyDictionary<TKey, Option<TValue>>>
	{
		...
		public Data<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>> ToData()
			=> new Data<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>(this);

		public static implicit operator Data<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>(OptionalOptionDictionaryValidationData<TKey, TValue> propertyData)
			=> propertyData.ToData();
	}
}
