...
{
	public class OptionalOptionDictionaryValidationData<TKey, TValue> : ValidationDataBase<Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>, IPropertyData<IReadOnlyDictionary<TKey, Option<TValue>>, Optional<IReadOnlyDictionary<TKey, Option<TValue>>>>, IRootValidationData<OptionalOptionDictionaryValidationData<TKey, TValue>, IReadOnlyDictionary<TKey, Option<TValue>>>
	{
		...
		public override Result<Unit, ValidationError[]> Validate(Optional<IReadOnlyDictionary<TKey, Option<TValue>>> value)
		{
