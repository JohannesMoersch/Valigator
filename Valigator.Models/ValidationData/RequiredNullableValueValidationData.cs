...
{
	public class RequiredNullableValueValidationData<TValue> : ValidationDataBase<Option<TValue>>, IPropertyData<TValue, Option<TValue>>, IRootValidationData<RequiredNullableValueValidationData<TValue>, TValue>
	{
		...
		public override Result<Option<TValue>, ValidationError[]> CoerceUnset()
			=> Result.Failure<Option<TValue>, ValidationError[]>(new[] { CoercionValidationErrors.UnsetValuesNotAllowed() });
