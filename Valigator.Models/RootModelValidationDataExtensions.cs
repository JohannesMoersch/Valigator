...
namespace Valigator
{
	...
	public static class RootModelValidationDataExtensions
	{
		...
		public static TNext ForEach<TNext, TModel, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyList<TValue>> data, Func<ValidatorValidationData<TValue>, IValidator<TValue>> selector)
		...
		public static TNext ForEach<TNext, TModel, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyList<Option<TValue>>> data, Func<ValidatorValidationData<TValue>, IValidator<TValue>> selector)
		...
		public static TNext ForEach<TNext, TModel, TKey, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyDictionary<TKey, TValue>> data, Func<ValidatorValidationData<KeyValuePair<TKey, TValue>>, IValidator<KeyValuePair<TKey, TValue>>> selector)
		...
		public static TNext ForEachKey<TNext, TModel, TKey, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyDictionary<TKey, TValue>> data, Func<ValidatorValidationData<TKey>, IValidator<TKey>> selector)
		...
		public static TNext ForEachValue<TNext, TModel, TKey, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyDictionary<TKey, TValue>> data, Func<ValidatorValidationData<TValue>, IValidator<TValue>> selector)
		...
		public static TNext ForEachValue<TNext, TModel, TKey, TValue>(this IRootModelValidationData<TNext, TModel, IReadOnlyDictionary<TKey, Option<TValue>>> data, Func<ValidatorValidationData<TValue>, IValidator<TValue>> selector)
