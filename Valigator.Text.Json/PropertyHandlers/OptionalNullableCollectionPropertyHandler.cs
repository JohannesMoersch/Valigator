...
{
	internal class OptionalNullableCollectionPropertyHandler<TObject, TValue, TSource> : ValigatorJsonPropertyHandler<TObject>
	{
		...
		public OptionalNullableCollectionPropertyHandler(PropertyInfo property)
		{
